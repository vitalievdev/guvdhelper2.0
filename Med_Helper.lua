...
local tagbuttons = {
	...
	{name = '{my_name}',text = 'Пишет Ваш ник из настроек.',hint = 'Здравия желаю, я {my_name}\n- Здравия Желаю, я Ваше имя.'},
	...
	{name = '{delay_*}',text = 'Добавляет задержку между сообщениями',hint = 'Добрый день, я сотрудник данной полиции, чем могу Вам помочь?\n{delay_2000}\n/do На груди висит бейджик с надписью работник больницы.\n\n[10:54:29] Добрый день, я сотрудник данной полиции, чем могу Вам помочь?\n[10:54:31] На груди висит бейджик с надписью сотрудник полиции.'},
}
local buttons = {
							...
							elseif updateinfo.version and updateinfo.version == thisScript().version then
								...
								imgui.BeginGroup()
									...
									if imgui.Button(u8'Проверить наличие обновлений') then
										checkUpdates('https://raw.githubusercontent.com/vitalievdev/guvdhelper20/main/Update/update.json', true)
									end
								imgui.EndGroup()
							else
								imgui.SetCursorPosY(30)
...
function main()
	...
	while true do
		...
		if configuration.main_settings.autoupdate and clock() - autoupd[0] > 600 then
			checkUpdates('https://raw.githubusercontent.com/vitalievdev/guvdhelper20/main/Update/update.json')
			autoupd[0] = clock()
		end
